...
export const AEAT_MODELS: AeatModel[] = [
  ...
  { model: '037', name: 'Declaración censal simplificada (personas físicas)', category: 'censos', periodicity: 'puntual', description: 'Versión simplificada del 036 para personas físicas con actividades sencillas', portal_url: 'https://sede.agenciatributaria.gob.es/Sede/procedimientoini/GC01.shtml' },
  ...
  { model: '349', name: 'IVA — Operaciones intracomunitarias', category: 'iva', periodicity: 'trimestral', description: 'Declaración recapitulativa de entregas y adquisiciones intracomunitarias', portal_url: 'https://sede.agenciatributaria.gob.es/Sede/procedimientoini/GI52.shtml' },
